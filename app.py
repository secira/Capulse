...
with app.app_context():
    ...
    _always_create = [
        ...
        # Production skips db.create_all(), so these tables must be created
        # unconditionally here — without RUN_MIGRATIONS=1 the wizard, result
        # page and dashboard badge will all 500 with "relation does not exist".
    ...
    try:
        ...
        logging.info("✅ Unconditional table bootstrap complete (api_partner, api_subscription, api_alert_log, alert_schedule, trader_profile, trader_answer, trader_progression)")
    except Exception as _e:
    ...
    _pending_migrations = [
        ...
        'ALTER TABLE research_list ADD COLUMN IF NOT EXISTS entry_timing VARCHAR(200)',
        'ALTER TABLE research_list ADD COLUMN IF NOT EXISTS exit_trigger TEXT',
        'ALTER TABLE research_list ADD COLUMN IF NOT EXISTS risk_score NUMERIC(5,2)',
        'ALTER TABLE research_list ADD COLUMN IF NOT EXISTS market_context_score NUMERIC(5,2)',
        'ALTER TABLE research_list ADD COLUMN IF NOT EXISTS risk_details JSONB',
        'ALTER TABLE research_list ADD COLUMN IF NOT EXISTS market_context_details JSONB',
